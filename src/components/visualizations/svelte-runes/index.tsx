...
import { CompiledCodePanel } from "./components/CompiledCodePanel";
...
export const SvelteRunes = () => {
  ...
  const showConsole = example.steps.some((s) => s.consoleOutput.length > 0);
          ...
          <div className="space-y-4">
            {example.compiledLines && (
              <CompiledCodePanel
                ...
                activeLine={currentStep?.compiledActiveLine ?? null}
                doneLines={currentStep?.compiledDoneLines ?? []}
                flash={flashes.compiled}
              />
            )}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                {currentStep ? <DomPanel nodes={currentStep.dom} /> : waiting}
              </NeonPanel>
            </div>
