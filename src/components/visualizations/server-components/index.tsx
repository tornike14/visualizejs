        ...
        <div className="grid gap-4 xl:grid-cols-[auto_minmax(0,1fr)]">
          ...
          <div className="min-w-0 space-y-4">
            ...
            <NeonPanel
              ...
              tone="amber"
              className={
                flashes.renderPhase ? "viz-change-flash" : undefined
              }
            >
              <PhaseBar
                currentPhase={currentStep?.renderPhase ?? "idle"}
              />
            </NeonPanel>
            ...
            <NeonPanel
              ...
              className={
                flashes.componentTree ? "viz-change-flash" : undefined
              }
            >
              {currentStep ? (
            ...
            <NeonPanel
              ...
              className={
                flashes.payload ? "viz-change-flash" : undefined
              }
            >
