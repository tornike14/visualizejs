...
export const EXAMPLES: ConcurrentRenderingExample[] = [
  /* ── 1. Blocking render ── */
  {
    ...
    steps: [
      ...
      {
        descriptionHtml:
          'The user types <code>a</code>. <code>onChange</code> runs inside a discrete browser event, so <code>setQuery("a")</code> is stamped with <span class="hl-stack">SyncLane</span>. A lane is one bit in a 31-bit mask; the lower the bit, the higher the priority, and SyncLane sits at the very bottom of the mask.',
        activeLine: 10,
  ...
  /* ── 2. startTransition ── */
  {
    ...
    codeLines: [
      ...
      {
        num: 11,
        text: "  const filtered = items.filter((i) => i.name.includes(filter));",
      },
      { num: 12, text: "  return (" },
      { num: 13, text: "    <>" },
  ...
  /* ── 3. useDeferredValue and Suspense ── */
  {
    ...
    codeLines: [
      ...
      {
        num: 7,
        text: "      <input value={query} onChange={(e) => setQuery(e.target.value)} />",
      },
      { num: 8, text: "      <Suspense fallback={<Spinner />}>" },
      {
        num: 9,
        text: "        <Results query={deferredQuery} dimmed={isStale} />",
      },
      ...
      {
        num: 14,
        text: "// Results calls use(fetchResults(query)) and suspends",
      },
    ...
    steps: [
      {
        ...
        dom: dom("", "", {
          suspense: { status: "content", note: 'Results ready for ""' },
        }),
      },
      {
        descriptionHtml:
      ...
      },
      {
        ...
        dom: dom("a", "", {
          ...
          suspense: {
            status: "content",
            note: "old results kept, fallback skipped",
          },
        }),
      },
      {
      ...
      },
      {
        ...
        dom: dom("a", "a", {
          suspense: { status: "content", note: 'Results ready for "a"' },
        }),
      },
      {
        descriptionHtml:
        ...
        lanes: [
          ...
          {
            id: "q-ab",
            update: 'setQuery("ab") without defer',
            lane: "SyncLane",
            status: "suspended",
          },
        ],
      ...
      },
      {
        ...
        dom: dom("ab", "a", {
          suspense: {
            status: "fallback",
            note: 'Spinner shown while "ab" loads',
          },
        }),
      },
    ],
