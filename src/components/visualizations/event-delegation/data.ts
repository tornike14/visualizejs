...
function makeTree(
  highlights: Record<
    string,
    "idle" | "capture-active" | "target-active" | "bubble-active" | "stopped"
  >,
...
export const EXAMPLES: EventDelegationExample[] = [
  /* ── 1. Capture & Bubble ── */
  {
    ...
    steps: [
      ...
      },
      {
        ...
        domTree: makeTree(
          {},
          { container: "capture", list: "bubble", "item-1": "bubble" },
        ),
        eventPath: [],
        currentPhaseLabel: null,
      },
      ...
      },
      {
        ...
        domTree: makeTree(
          { container: "capture-active" },
          { container: "capture", list: "bubble", "item-1": "bubble" },
        ),
        eventPath: [
          {
            nodeLabel: "div#container",
            phase: "capture",
            handlerFired: true,
            stopped: false,
          },
  ...
  /* ── 2. stopPropagation ── */
  {
    ...
    steps: [
      ...
      },
      {
        ...
        domTree: makeTree(
          {},
          { container: "bubble", list: "bubble", "item-1": "bubble" },
        ),
        eventPath: [],
        currentPhaseLabel: null,
      },
  ...
  /* ── 3. Event Delegation ── */
  {
    ...
    codeLines: [
      ...
      {
        num: 8,
        text: '  console.log("currentTarget: " + e.currentTarget.id);',
      },
      { num: 9, text: "});" },
      { num: 10, text: "" },
