...
import { EmbeddingsPanels } from "./components/EmbeddingsPanels";
  ...
  const flashes = useChangeFlash(
    {
      ...
      primaryTable: currentStep?.primaryTable,
      secondaryTable: currentStep?.secondaryTable,
      chips: currentStep?.chips,
      bars: currentStep?.bars,
      computation: currentStep?.computation,
    },
    currentStepIndex,
  );
