...
export const EXAMPLES: ScopeExample[] = [
  ...
  // ---- Example 2: Block vs Function Scope ----
  {
    ...
    steps: [
      ...
      {
        descriptionHtml:
          "<code>demo()</code> is called. A function scope is created with bindings for <code>a</code> and <code>b</code>; their values are assigned as the lines run.",
        activeLine: 13,
        doneLines: [],
        scopes: [
          {
      ...
      {
        descriptionHtml:
          "Entering the <code>if</code> block. A new <strong>block scope</strong> is created. It will hold its own <code>b</code> once line 7 runs, shadowing the outer <code>b</code>.",
        activeLine: 5,
        doneLines: [1, 2, 3, 13],
        scopes: [
          {
